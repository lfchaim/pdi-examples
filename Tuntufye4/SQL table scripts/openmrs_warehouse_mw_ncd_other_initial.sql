...
--
-- Table structure for table `mw_ncd_other_initial`
--
...
CREATE TABLE `mw_ncd_other_initial` (
  `ncd_other_initial_visit_id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `diagnosis_date_ other` date DEFAULT NULL,
...
--
-- Dumping data for table `mw_ncd_other_initial`
--

LOCK TABLES `mw_ncd_other_initial` WRITE;
/*!40000 ALTER TABLE `mw_ncd_other_initial` DISABLE KEYS */;
/*!40000 ALTER TABLE `mw_ncd_other_initial` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-05-24 13:22:14
